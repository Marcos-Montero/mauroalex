"use client";
import { MenuIcon, PencilIcon, UserIcon } from "lucide-react";
    ...
    <>
      <div className="flex w-screen bg-black/50 px-8 border-b border-white/10  items-center py-2">
        ...
        <div className="flex gap-4 self-end ">
          ...
          {/*           <SessionProvider>
            <SignInButton className=" w-8 h-8 p-0 text-white hover:scale-110 duration-300" />
          </SessionProvider>
          <SessionProvider>
            <LogOutButton className=" w-8 h-8 p-0 text-white hover:scale-110 duration-300" />
          </SessionProvider> */}
        </div>
      </div>
    </>
